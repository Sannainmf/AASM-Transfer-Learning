# train_cf_cnn_budget.py
# 1D-CNN data budget study for Cf: transfer vs scratch at different RANS fractions
...
xfoil_cf_n = shared_norm.norm_out(xfoil_cf)
...
with open(os.path.join(PROJECT_DIR, "Results", "cf_cnn_budget.json"), 'w') as f:
