# train_cf_cnn_model_c.py
# 1D-CNN Model C: pretrain on XFOIL Cf, finetune on RANS Cf
...
with open(os.path.join(PROJECT_DIR, "Results", "cf_cnn_model_c.json"), 'w') as f:
