# train_cf_cnn_model_a.py
# 1D-CNN Model A: train on XFOIL Cf only, evaluate on RANS test set
...
xfoil_cf_n = norm.norm_out(xfoil_cf)
...
with open(os.path.join(PROJECT_DIR, "Results", "cf_cnn_model_a.json"), 'w') as f:
