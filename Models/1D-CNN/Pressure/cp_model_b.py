# train_cp_cnn_model_b.py
# 1D-CNN Model B: train on RANS Cp from scratch
...
with open(os.path.join(PROJECT_DIR, "Results", "cp_cnn_model_b.json"), 'w') as f:
