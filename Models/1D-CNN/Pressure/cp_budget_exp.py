# train_cp_cnn_budget.py
# 1D-CNN data budget study for Cp: transfer vs scratch at different RANS fractions
...
with open(os.path.join(PROJECT_DIR, "Results", "cp_cnn_budget.json"), 'w') as f:
