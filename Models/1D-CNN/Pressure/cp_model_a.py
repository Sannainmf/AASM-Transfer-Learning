# train_cp_cnn_model_a.py
# 1D-CNN Model A: train on XFOIL Cp only, evaluate on RANS test set
...
with open(os.path.join(PROJECT_DIR, "Results", "cp_cnn_model_a.json"), 'w') as f:
