# train_cf_budget.py
# Data budget study for Cf: transfer vs scratch at different RANS fractions
...
with open(os.path.join(PROJECT_DIR, "Results", "cf_mlp_budget.json"), 'w') as f:
