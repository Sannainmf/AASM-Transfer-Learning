# train_cp_fno_budget.py
# FNO data budget study for Cp: transfer vs scratch at different RANS fractions
...
xfoil_X_n = shared_norm.norm_in(xfoil_X); xfoil_cp_n = shared_norm.norm_out(xfoil_cp)
...
with open(os.path.join(PROJECT_DIR, "Results", "cp_fno_budget.json"), 'w') as f:
