# train_cp_fno_model_b.py
# FNO Model B: train on RANS Cp from scratch
...
train_X_n = norm.norm_in(train_X); train_cp_n = norm.norm_out(train_cp)
...
with open(os.path.join(PROJECT_DIR, "Results", "cp_fno_model_b.json"), 'w') as f:
