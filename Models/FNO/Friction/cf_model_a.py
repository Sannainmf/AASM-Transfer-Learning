# train_cf_fno_model_a.py
# FNO Model A: train on XFOIL Cf only, evaluate on RANS test set
...
with open(os.path.join(PROJECT_DIR, "Results", "cf_fno_model_a.json"), 'w') as f:
