# train_cf_fno_model_b.py
# FNO Model B: train on RANS Cf from scratch
...
with open(os.path.join(PROJECT_DIR, "Results", "cf_fno_model_b.json"), 'w') as f:
