"""
Figure 8: Cf Data Efficiency Curve
...
mlp = load("final_results_mlp.json")["cf_efficiency"]
cnn = load("final_results_cnn.json")["cf_efficiency"]
fno = load("final_results_fno.json")["cf_efficiency"]
...
ax.set_ylabel(r"$C_f$ RMSE Improvement over Scratch (%)")
ax.set_xticks(x)
...
out = os.path.join(OUT_DIR, "fig8_cf_budget.png")
